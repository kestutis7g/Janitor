...
namespace Janitor_V1
{
    ...
    public class SwAddin : ISwAddin
    {
        ...
        public void AddCommandMgr()
        {
            ...
            string Title = "Janitor_V1", ToolTip = "Janitor_V1";
            ...
            cmdGroup.LargeIconList = iBmp.CreateFileFromResourceBitmap("Janitor_V1.ToolbarLarge.bmp", thisAssembly);
            cmdGroup.SmallIconList = iBmp.CreateFileFromResourceBitmap("Janitor_V1.ToolbarSmall.bmp", thisAssembly);
            cmdGroup.LargeMainIcon = iBmp.CreateFileFromResourceBitmap("Janitor_V1.MainIconLarge.bmp", thisAssembly);
            cmdGroup.SmallMainIcon = iBmp.CreateFileFromResourceBitmap("Janitor_V1.MainIconSmall.bmp", thisAssembly);
