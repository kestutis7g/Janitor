...
namespace Janitor_V1
{
    ...
    {
        private string WorkingDirectory { get; set; } //C:\\Users\\Dell\\OneDrive - UAB Novatronas\\DARBAI su SOLIDWORKS_V2019\\JANITOR\\Janitor_V1\\
        ...
        // constructor
        public MainForm(string workingDirectory)
        {
            InitializeComponent();
